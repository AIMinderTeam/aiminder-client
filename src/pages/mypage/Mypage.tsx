...
export default function Mypage() {
  return (
    <section className="flex flex-col gap-2 px-5 py-0">
      <Link to="/login" className="flex items-center justify-between rounded-sm border border-gray-200 bg-gray-50 p-3">
        <span className="text-sm font-bold">로그인</span> <ChevronRight />
      </Link>
      <Link
        to="/mypage/review"
